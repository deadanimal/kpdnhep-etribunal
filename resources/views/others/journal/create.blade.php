...
{{ Form::open(['route' => 'others.journal.update', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'submitForm']) }}
@else
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body ">
                <div class="form-group form-md-line-input"">
                    ...
                    <div class="col-md-6">
                        <label class="control-label">{{ $journal->journal_desc }}</label>
                        <input type="hidden" value="{{ $journal->journal_desc }}" id="journal_desc" name="journal_desc" />
                        <!-- <textarea id="journal_desc" name="journal_desc" class="form-control" maxlength="225" rows="2" placeholder=""> @if($journal->journal_desc) {{ $journal->journal_desc }} @endif</textarea> -->
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-6">
                        <label class="control-label">{{ $journal->classification->category->$category_lang }}</label>
                        <input type="hidden" value="{{ $journal->classification->category_id }}" id="claim_category_id" name="claim_category_id" />
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="control-label">{{ $journal->classification->$classification_lang }}</label>
                        <input type="hidden" value="{{ $journal->claim_classification_id }}" id="claim_classification_id" name="claim_classification_id" />
                        <span class="help-block"></span>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $("#is_status_active").prop("checked", true);
    @else
    $("#is_status_inactive").prop("checked", true);
    @endif
   ...
   @if($journal->claim_classification_id)
        $('#claim_category_id').val({{ $journal->classification->category_id }}).trigger('change');

        
        @if( $journal->claim_classification_id )
            $('#claim_classification_id').val({{ $journal->claim_classification_id }}).trigger('change');
        @endif
    @endif
