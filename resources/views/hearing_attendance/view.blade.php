        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> {{ __('hearing.hearing_attendance_list') }} </span>
                </div>          
                <div class="tools"> </div>
            </div>
                ...
                <table id="stop_reason" class="table table-striped table-bordered table-hover table-responsive">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style="text-align: center;float: center" rowspan="2">{{ __('hearing.list_form')}}2</th>
                            <th style="text-align: center;float: center" rowspan="2">{{ __('hearing.list_form')}}3</th>
                            <th style="text-align: center;float: center" rowspan="2">{{ __('hearing.list_form')}}11</th>
                            <th style="text-align: center;float: center" rowspan="2">{{ __('hearing.list_form')}}12</th>
                            <th style="text-align: center;float: center" colspan="2">{{ __('new.attendance_status')}}</th>  
                        </tr>
                        <tr>
                            <th style="text-align: center;float: center">{!! __('hearing.list_claimant') !!}</th>
    ...
    var TableDatatablesButtons = function () {
        ...
        var initTable1 = function () {
            ...
            var oTable = table.DataTable({
                ...
                { data: "claimant_name", name:"case.claimant.name", 'orderable' : false},
                { data: "opponent_name", name:"case.opponent.name", 'orderable' : false},
