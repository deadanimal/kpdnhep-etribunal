<!-- 
<p>Anda telah berjaya mendaftar ke dalam sistem. Terima Kasih.</p></h3>

<p>Anda boleh log masuk ke dalam sistem dengan menggunakan nombor kad pengenalan anda dan kata laluan. :</p>

<p><b>Nombor Kad Pengenalan :</b>{{ $identification_no or ''}}</p>


<p><b>Kata Laluan :</b>{{ $password or '' }}</p>

<p><b>Tekan sini untuk log masuk : <a href="{{ route('login') }}">http://103.21.183.181/etribunalv2_2_git</a></b></p> -->
                                            ...
                                            <td class="m_2541210229120469261content-cell" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                                    <span class="im">
                                                        ...
                                                        <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">   
                                                            ...
                                                            <center><p>Click here to log in : <a href="{{ route('login') }}">{{ env('APP_URL') }}</a></p></center>
                                                                        ...
                                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
                                                                            ...
                                                                            <table class="m_2541210229120469261subcopy" width="100%" cellpadding="0" cellspacing="0" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;border-top:1px solid #edeff2;margin-top:25px;padding-top:25px">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
                                                                                        <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;line-height:1.5em;margin-top:0;text-align:left;font-size:12px"> <a href="{{ env('APP_URL') }}/password/reset/94787717b279f5d314d629715039e910377cca048bb272b7356e8d7052ff645f" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#3869d4" target="_blank" data-saferedirecturl="https://www.google.com/url?hl=en&amp;q={{ env('APP_URL') }}/password/reset/94787717b279f5d314d629715039e910377cca048bb272b7356e8d7052ff645f&amp;source=gmail&amp;ust=1499954301863000&amp;usg=AFQjCNG16QT6l5_NQkPqRF2ot9ltE5qh2g"></a><a href="{{ env('APP_URL') }}/password/reset/94787717b279f5d314d629715039e910377cca048bb272b7356e8d7052ff645f" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#3869d4" target="_blank" data-saferedirecturl="https://www.google.com/url?hl=en&amp;q={{ env('APP_URL') }}/password/reset/94787717b279f5d314d629715039e910377cca048bb272b7356e8d7052ff645f&amp;source=gmail&amp;ust=1499954301863000&amp;usg=AFQjCNG16QT6l5_NQkPqRF2ot9ltE5qh2g"></a></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
...
<p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">   <center>   <p>ID Pengguna : {{ $identification_no or ''}}</p></center>
            <center>    <p>Kata Laluan : {{ $password or '' }}</p>      </center>
                <center><p>Tekan di sini untuk masuk : <a href="{{ route('login') }}">{{ env('APP_URL') }}</a></p></center>
              <center><p> Terima Kasih kerana mendaftar menjadi pengguna e-Tribunal.Pendaftaran anda telah berjaya dan anda boleh membuat pemfailan mengenai tuntutan anda Tribunal Tuntutan Pengguna Malaysia melalui sistem ini.</p></center>                         
                  <center> <p>  Ini adalah e-mel yang dihasilkan oleh sistem.Tidak perlu dibalas.</p></center>
                                <br/><br/></p>
