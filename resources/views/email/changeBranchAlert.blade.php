                                            ...
                                            <td class="m_2541210229120469261content-cell" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                                <span class="im">
                                                    ...
                                                    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">   
                                                        <center><p>Please be noted that a claim case ({{ $case->case_no }}) has been transfered to your branch for further action.</p></center>
                                                        <br>
                                                    </p>
                                            ...
                                            <tr>
                                                <td class="m_2541210229120469261content-cell" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px"><span class="im">
                                                    ...
                                                    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                        ...
                                                        <center><p>Sila ambil perhatian bahawa kes tuntutan ({{ $case->case_no }}) telah dipindahkan ke cawangan anda untuk tindakan lanjut.</p></center>
                                                        <br>
