                ...
                <form class="form-horizontal" role="form">
                    <div class="form-body">
                        <div class="form-group form-md-line-input">
                            <label for="pass_old" class="control-label col-md-5">{{ __('new.old_password') }} :
                        ...
                        <div class="form-group form-md-line-input">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="help-block">{{ __('new.field_required_alert') }}. {{ trans('new.validation_pswd') }}.</span>
                            </div>
                        </div>
                        <div class="form-group form-md-line-input">
