        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <table id="searchtab2" class="table table-striped table-bordered table-hover table-responsive mt5"
                           width="100%">
                        <thead>
                        <tr>
                            <th width="2%">{{ __('new.no')}}</th>
                            <th>{{ __('new.inquiry')}}</th>
                            <th>{{ __('new.claimant_name')}}</th>
                            <th>{{ __('new.ic')}}</th>
                            <th>{{ __('new.opponent_name')}}</th>
                            <th>{{ __('new.company_no')}}</th>
                            <th>{{ __('new.question_details')}}</th>
                        </tr>
                        </thead>
                    </table>
                </div>
        ...
        var initTable1 = function () {
          ...
          var oTable = table.DataTable({
            ...
            'columns': [
              ...
              { data: 'inquiry_no', name: 'inquiry_no', 'orderable': false, 'searchable': false },
              { data: 'name', name: 'inquired_by.name', 'orderable': false, 'searchable': false },
              {
                data: 'identification_no',
                name: 'inquired_by.username',
              ...
              { data: 'opponent_name', name: 'opponent.name', 'orderable': false, 'searchable': false },
              {
                data: 'opponent_identification_no',
                name: 'opponent.identification_no',
                orderable: false,
                searchable: false
              },
              { data: 'inquiry_msg', name: 'inquiry_msg', 'orderable': false, 'searchable': false }
            ],
