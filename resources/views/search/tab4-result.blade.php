        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <table id="form1_search" class="table table-striped table-bordered table-hover table-responsive mt5"
                           width="100%">
                        <thead>
                        <tr>
                            <th width="2%">{{ __('master.no')}}</th>
                            <th>{{ __('new.form1_no')}}</th>
                            <th>{{ __('new.name')}}</th>
        ...
        var initTable1 = function () {
          ...
          var oTable = table.DataTable({
            ...
            'columns': [
              ...
              { data: 'form1_no', name: 'case_no', 'orderable': false, 'searchable': false },
              { data: 'name', name: 'case.claimant_address.name', 'orderable': false, 'searchable': false },
              { data: 'username', name: 'case.claimant_address.username', 'orderable': false, 'searchable': false },
              { data: 'status', name: 'case.case_status_id', 'orderable': false, 'searchable': false }
            ],
