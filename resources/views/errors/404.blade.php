...
<head>
    ...
    <meta content="404 page" name="description" />
...
<body class=" page-404-full-page">
    <div class="row">
        <div class="col-md-12 page-404">
            <div class="number font-red" style="top: 10px;"> 404 </div>
            <div class="details">
                <h3>{{ __('error.404_header') }}</h3>
                <p>
                    {{ $exception->getMessage() ? $exception->getMessage() : __('error.404_description') }}<br>
                    {{ __('error.contact_at') }} <a style="color: #e7505a;" href="mailto:upa1helpdesk@kpdnhep.gov.my">upa1helpdesk@kpdnhep.gov.my</a>
                </p>
            </div>
        </div>
        <div class="col-md-12 page-404">
            <a href="/" class="btn btn-default">Back to portal</a>
        </div>
    </div>
