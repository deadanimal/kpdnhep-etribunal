    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
          <div class="caption font-dark">
              ...
              <span class="caption-subject bold uppercase"> {{ __('master.application_method') }} </span>
          </div>
          <div class="tools"> </div>
      </div>
      <div class="portlet-body">
        ...
        <thead>
          <tr>
            ...
            <th>{{ __('master.application_method') }} (EN)</th>            
            <th>{{ __('master.application_method') }} (MY)</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ __('master.application_method_info')}}</h4>
            </div>
...
var TableDatatablesButtons = function () {
    ...
    var initTable1 = function () {
        ...
        var oTable = table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('master.application_method') }}",
            "deferRender": true,
            "pagingType": "bootstrap_full_number",
            "columns": [
                 // {data: 'rownum'},
                { data: "application_method_id", name:"application_method_id", searchable: false},
            ...
            buttons: [
                {
                text:"<i class=\"fa fa-plus margin-right-5\"></i> {{ __('master.add_application_method') }}", className:"btn blue btn-outline", action:function()
                    {
                        window.location.href = "{{ route('master.application_method.create') }}"; 
                    }
                },
                {
                    extend: 'print',
                    ...
                    title: function(){
                        return "<span style='font-size: 22px'><strong>e-Tribunal V2 | </strong>{{ __('new.application_method') }}</span>"; // #translate
                    },
                    ...
                    customize: function ( win ) {
                        ...
                        win.document.title = "{{ __('new.application_method') }}";
...
function deleteApplicationMethod(id) {
    swal({
        title: "{{ __('swal.delete_application_method')}}",
    ...
    function(){
        ...
        $.ajax({
            url: "{{ route('master.application_method') }}/"+id+"/delete",
            type: "DELETE",
            data : {
                _token:_token,
                id:id
...
function activateApplicationMethod(id) {
    swal({
    ...
    function(){
        ...
        $.ajax({
            url: "{{ route('master.application_method') }}/"+id+"/activate",
            type: "POST",
            data : {
                _token:_token,
                id:id
