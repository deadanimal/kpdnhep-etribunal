    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
          <div class="caption font-dark">
              ...
              <span class="caption-subject bold uppercase">{{ __('master.term') }}</span>
          </div>
          <div class="tools"> </div>
      </div>
      <div class="portlet-body">
        ...
        <thead>
          <tr>
            ...
            <th>{{ __('master.duration_en') }}</th>            
            <th>{{ __('master.duration_my') }}</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ __('master.term_info')}}</h4>
            </div>
...
var TableDatatablesButtons = function () {
    ...
    var initTable1 = function () {
        ...
        var oTable = table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('master.term') }}",
            "deferRender": true,
            "pagingType": "bootstrap_full_number",
            "columns": [
                 // {data: 'rownum'},
                { data: "duration_term_id", name:"duration_term_id", searchable: false},
                { data: "term_en", name:"term_en", 'orderable' : false},
                { data: "term_my", name:"term_my", 'orderable' : false},
            ...
            buttons: [
                {
                text:"<i class=\"fa fa-plus margin-right-5\"></i> {{ __('master.add_term') }}", className:"btn blue btn-outline", action:function()
                    {
                        window.location.href = "{{ route('master.term.create') }}"; 
                    }
                },
                {
                    extend: 'print',
                    ...
                    title: function(){
                        return "<span style='font-size: 22px'><strong>e-Tribunal V2 | </strong>{{ __('master.term') }}</span>"; // #translate
                    },
                    ...
                    customize: function ( win ) {
                        ...
                        win.document.title = "{{ __('master.term') }}";
    ...
    function deleteTerm(id) {
        ...
        function(){
            ...
            $.ajax({
                url: "{{ route('master.term') }}/"+id+"/delete",
                type: "DELETE",
                data : {
                    _token:_token,
                    id:id
    ...
    function activateTerm(id) {
        ...
        function(){
            ...
            $.ajax({
                url: "{{ route('master.term') }}/"+id+"/activate",
                type: "POST",
                data : {
                    _token:_token,
                    id:id
