  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                <label for="process_date" class="control-label col-md-5"> {{ __('hearing.hearing_date')}}  :
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-6">
                                    <select required class="form-control select2 bs-select" id="hearing_date" name="hearing_date"  data-placeholder="---">
        ...
        <div class="modal-footer">
            ...
            <a class="btn green-sharp" onclick='submitUpdate()'>{{ trans('button.update') }}</a>
        </div>
    </div>
