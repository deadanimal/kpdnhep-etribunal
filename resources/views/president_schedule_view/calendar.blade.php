...
<div class="row">
    <div class="col-md-3 col-sm-12">
        ...
        <h3 class="event-form-title margin-bottom-20">{{ __('new.event') }}</h3>
        <div id="external-events">
            <form class="inline-form">
                <input type="text" value="" class="form-control" placeholder="Event Title..." id="event_title" />
                <br/>
                <a href="javascript:;" id="event_add" class="btn green">{{ __('new.add_event') }} </a>
            </form>
            <hr/>
            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline" for="drop-remove"> {{ __('new.remove_after_drop') }} 
        ...
        initCalendar: function() {
            if (jQuery().fullCalendar) {
                ...
                eventMouseover: function (data, event, view) {
                    ...
                    tooltip = '<div class="tooltiptopicevent" style="width:auto;height:auto;background:#d9d9d9;position:absolute;z-index:10001;padding:10px 10px 10px 10px ;  line-height: 200%;">' + '{{ __('new.holiday')}} : ' + data.nama + '</br>';
