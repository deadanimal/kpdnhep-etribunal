    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
          <div class="caption font-dark">
              ...
              <span class="caption-subject bold uppercase">{{ trans('acl.role_list') }}</span>
          </div>
          <div class="tools"> </div>
      </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ trans('acl.role_info') }}</h4>
            </div>
...
$('body').on('click', '.btnModalPeranan', function(e){
    e.preventDefault();
...
var TableDatatablesButtons = function () {
    ...
    var initTable1 = function () {
        ...
        var oTable = table.DataTable({
            ...
            buttons: [
                {
                text:"<i class=\"fa fa-plus margin-right-5\"></i> {{ trans('new.add_role') }}", className:"btn blue btn-outline", action:function()
                    {
                        window.location.href = "{{ route('admins.createroles') }}";
                    }
                },
                ...
                success: function (response) {
                    if(response.status=='ok'){
                        swal({
                            ...
                            text: " {{ trans('swal.success_delete') }}.",
                            type: "success",
                            timer: 500,
                        ...
                        swal("{{ trans('swal.fail') }} !", "{{ trans('swal.fail_deleted') }}.", "error");
                    }
                }
            });
            // deletes.submit();
