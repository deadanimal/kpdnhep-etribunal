            ...
            <td colspan="2">
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding-top: 10px">Tuan / puan dikehendaki menyerahkan award ini secepat mungkin ke
                            atas Penentang dengan serahan tangan atau dengan cara pos berdaftar akuan terima.
                        </td>
                    </tr>
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top; padding-top: 10px">(2)</td>
                        <td style="padding-top: 10px">Bukti penyerahan award tersebut hendaklah disimpan oleh tuan /
                            puan bagi tujuan penguatkuasaan award ini.
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="2" style="padding-top: 20px;">
                ...
                <table>
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top; padding-top: 10px">(1)</td>
                        <td style="padding-top: 10px">Tuan/puan hendaklah mematuhi award ini dalam
                    ...
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top; padding-top: 10px">(2)</td>
                        <td style="padding-top: 10px">Kegagalan tuan/puan mematuhi award ini dalam
                            masa {{ $form4->award->award_obey_duration ? $form4->award->award_obey_duration : 14 }} {{ $form4->award->term ? strtolower($form4->award->term->term_my) : 'hari' }}
                            daripada tarikh award ini diterima oleh tuan / puan atau dalam masa yang telah ditetapkan
                            dalam award, adalah menjadi suatu kesalahan jenayah di bawah <span
                                    style="font-weight: bold">Seksyen 117 Akta Pelindungan Pengguna (APP) 1999</span>
    ...
    <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td width="10%" style="text-align: center; vertical-align: top;">(b)</td>
                                    <td>
                                        <span class="title">Seksyen 117(2) APP 1999</span><br>
                    ...
                    @if($form4->award->award_type != 10 && $form4->award->award_type != 9)
                        <tr>
                            ...
                            <td style="padding-top: 5px">Jika tuan/puan mempertikaikan award ini, tuan/puan boleh
                                ...
                                puluh (30) hari selepas award diterima.
                            </td>
                        </tr>
                    @endif
                </table>
        ...
        <tr>
            <td colspan="2" style="padding-top: 50px;">
                ...
                tempoh {{ $form4->award->award_obey_duration ? $form4->award->award_obey_duration : 14 }} {{ $form4->award->term ? $form4->award->term->term_my : 'hari' }}
                dari tarikh award ini di terima atau gagal mematuhi award ini mengikut tempoh masa yang telah ditetapkan
                di dalam award, tuan / puan boleh:-
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding-top: 5px">
                            ...
                            supaya tindakan boleh diambil untuk mendakwa Penentang di Mahkamah di bawah seksyen 117 Akta
                    ...
                    <tr>
                        ...
                        <td style="padding-top: 5px">
                            Sesalinan aduan tersebut hendaklah dihantarkan kepada
                            <span style="font-weight: bold">
        ...
        <tr>
            <td colspan="2" style="padding-top: 10px;">
                <table>
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top; padding-top: 5px">(3)</td>
                        <td style="padding-top: 5px">tuan / puan juga boleh memilih untuk menguatkuasakan award ini
                            dengan sendiri di bawah seksyen 116(1)(b) Akta Perlindungan Pengguna 1999 di
                            <span style="font-weight: bold">
