...
<body class="center">
	...
	<div>
		...
		<span class='bold uppercase'>{{ $form4->case->transfer_branch_id == NULL ? $form4->case->branch->state->state : $form4->case->transfer_branch->state->state }}</span>
		...
		<div class='left'>
			<p class="justify indent">The statement of claim (Form 1) having been duly served on the respondent and the Respondent having failed to file his defence within the stipulated time, the Tribunal hereby makes the following award:</p>
