            ...
            <td colspan="2">
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding-top: 5px">You are required to submit this award as soon as possible against
                            the Respondent by way of a registered post or by hand.
                        </td>
                    </tr>
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top; padding-top: 5px">(2)</td>
                        <td style="padding-top: 5px">The proof of delivery of the award shall be kept by you for the
                            purpose of enforcement of this award.
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table>
                    <tr>
                        ...
                        <td style="padding-top: 5px">You must comply with this award
                            ...
                            from the date award was received or to comply with this award within the period set forth in
                            the award.
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-top: 5px">If you fail to comply with this award
                            ...
                            period in the award, it shall be a criminal offence under <span style="font-weight: bold">Section 117 of the Consumer Protection Act (CPA) 1999</span>
                            as follows:
                    </tr>
    ...
    <table>
        <tr>
            ...
            <td>
                <table>
                    <tr>
                        <td width="10%" style="text-align: right; vertical-align: top; ">(a)</td>
                        <td><span class="title">Section 117(1) CPA 1999</span><br>
                            <span style="text-decoration: underline;">First Offence</span> - Fine not exceeding RM5,000
                            or imprisonment for a term not more than two (2) years or to both.
                        </td>
                    </tr>
                    <tr>
                        <td width="10%" style="text-align: right; vertical-align: top; padding-top: 5px">(b)</td>
                        <td style="padding-top: 5px"><span class="title">Section 117(2) CPA 1999</span><br>
                            <span style="text-decoration: underline;">Continuing Offences</span> - In addition to
                            penalties under section 117 (1) above, a fine not exceeding RM1,000 for each day or part of
        ...
        @if($form4->award->award_type != 10 && $form4->award->award_type != 9)
            <tr>
                <td width="10%" style="text-align: center; vertical-align: top; padding-top: 5px">(3)</td>
                <td style="padding-top: 5px">If you disagree with this award, you may set aside this award by filing an
                    application in Form 12 within thirty days after the award is received.
                </td>
            </tr>
        @endif
        <tr>
            <td colspan="2" style="padding-top: 10px;">
                ...
                <table>
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top;">(1)</td>
                    ...
                    <tr>
                        <td width="10%" style="text-align: center; vertical-align: top; padding-top: 5px">(2)</td>
                        <td style="padding-top: 5px">
                            a copy of the complaint shall be sent to
                            <span style="font-weight: bold">
