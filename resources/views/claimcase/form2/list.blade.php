            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">{{ trans('form2.form2_list') }}</span>
                    </div>
                    <div class="tools"></div>
                </div>
                ...
                <div class="portlet-body">
                    <table id="roles" class="table table-striped table-bordered table-hover table-responsive">
                        ...
                        <tr>
                            ...
                            <th>{!! trans('form2.filing_date_form2') !!}</th>
                            <th>{!! __('form1.filing_date_form1') !!}</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ trans('form2.form2_details') }}</h4>
                </div>
...
@section('after_scripts')
    ...
    <script type="text/javascript">
      ...
      function choosePaymentMethod(id) {
        $('#modalDiv').load("{{ url('/') }}/payment/case/" + id + '/2')
      }
        ...
        var initTable1 = function () {
          ...
          var oTable = table.DataTable({
            ...
            'columns': [
              ...
              { data: 'filing_date_form2', name: 'form2.filing_date' },
              { data: 'filing_date_form1', name: 'claimCase.form1.filing_date' },
              { data: 'matured_date', name: 'form2.matured_date', 'orderable': false },
              {
                data: 'case_no', name: 'claimCase.case_no', 'orderable': false, 'render': function (data, type, full) {
                  return $('<div/>').html(data).text()
                }
              },
              { data: 'claimant_name', name: 'claimCase.claimant_address.name', 'orderable': false },
              { data: 'opponent_name', name: 'opponent_address.name', 'orderable': false },
              { data: 'status', name: "form2.status.form_status_desc_{{ App::getLocale() }}", 'orderable': false },
            ...
            buttons: [
              ...
              {
                text: "<i class=\"fa fa-plus margin-right-5\"></i> {{ trans('form2.form2') }} ",
                className: 'btn blue btn-outline', action: function () {
                  window.location.href = "{!! Auth::user()->user_type_id == 3 ? route('onlineprocess.form1', ['form2' => 'unfiled', 'status' => '0']) : route('onlineprocess.form1', ['form2' => 'unfiled', 'status' => '0', 'branch' => auth()->user()->ttpm_data->branch_id ]) !!}"
                }
              },
                    @endif
              {
                ...
                title: function () {
                  return "<span style='font-size: 22px'><strong>e-Tribunal V2 | </strong>{{ trans('form2.form2_list') }}</span>" // #translate
                },
                ...
                customize: function (win) {
                  ...
                  win.document.title = "{{ trans('form2.form2_list') }}"
