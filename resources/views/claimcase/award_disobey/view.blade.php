            ...
            <div class="portlet-body">
                <div class="tabbable-line">
                    <ul class="nav nav-tabs ">
                        <li class="active">
                            <a href="#tab_transaction" data-toggle="tab" aria-expanded="true"> {{ __('new.award_disobey_info')}} </a>
                        </li>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group" style="display: flex;">
                                                ...
                                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                                    ...
                                                    @if($award_disobey->applied_by == 1)
                                                        {{ trans("new.ttpm_parties") }}
                                                    @elseif($award_disobey->applied_by == 2)
                                                        {{ $award_disobey->form4->case->claimant->name }}
                                                    @elseif($award_disobey->applied_by == 3)
                                                        {{ $award_disobey->form4->case->opponent->name }}
                                                    @endif
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="form-group" style="display: flex;">
                                                ...
                                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                                    <span id="view_purchased_item">
                                                        @if($award_disobey->applied_against == 1)
                                                            {{ trans("new.ttpm_parties") }}
                                                        @elseif($award_disobey->applied_against == 2)
                                                            {{ $award_disobey->form4->case->claimant->name }}
                                                        @elseif($award_disobey->applied_against == 3)
                                                            {{ $award_disobey->form4->case->opponent->name }}
                                                        @endif
                                                    </span>
                                                </div>
                                            ...
                                            <div class="form-group" style="display: flex;">
                                                ...
                                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                                    <span id="view_purchased_brand">{{ $award_disobey->form4->award->created_at ? date('d/m/Y', strtotime($award_disobey->form4->award->created_at)) : '' }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group" style="display: flex;">
                                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('new.complaint_date')}}</div>
                                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                                    <span id="view_purchased_amount">{{ $award_disobey->complaint_at ? date('d/m/Y', strtotime($award_disobey->complaint_at)) : '' }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group" style="display: flex;">
                                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('new.complaints')}}</div>
                                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                                    <span id="view_purchased_amount2">{{ $award_disobey->complaints }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                ...
                <form action="#" class="form-horizontal form-bordered ">
                    ...
                    <div class="form-body">
                        <div class="form-group" style="display: flex;">
                            ...
                            @endif</div>
                            <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                <span id="view_opponent_identification_no">{{ $claim_case->opponent_address->identification_no }}</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="display: flex;">
                            <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.nationality') }} </div>
                            <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                <span id="view_opponent_nationality">{{ $claim_case->opponent_address->nationality->country }}</span>
                            </div>
                        </div>
                        @endif
                        <div class="form-group" style="display: flex;">
                            <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.name') }} </div>
                            <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                <span id="view_opponent_name">{{ $claim_case->opponent_address->name }}</span>
                            </div>
                        </div>
                        ...
                        <div id="opponent_info" style="display:none;">
                            ...
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.address_street') }}</div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_street1">{{ $claim_case->opponent_address->street_1 }}<br>{{ $claim_case->opponent_address->street_2 }}<br>{{ $claim_case->opponent_address->street_3 }}
                                    </span>
                                </div>
                            </div>
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.postcode') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_postcode">{{ $claim_case->opponent_address->postcode }}</span>
                                </div>
                            </div>
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.district') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_district">{{ $claim_case->opponent_address->district ? $claim_case->opponent_address->district->district : '-' }}</span>
                                </div>
                            </div>
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.state') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_state">{{ $claim_case->opponent_address->state ? $claim_case->opponent_address->state->state : '' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.home_phone') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_phone_home">{{ $claim_case->opponent_address->phone_home }}</span>
                                </div>
                            </div>
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.mobile_phone') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_phone_mobile">{{ $claim_case->opponent_address->phone_mobile }}</span>
                                </div>
                            </div>
                            @endif
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.office_phone') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_phone_office">{{ $claim_case->opponent_address->phone_office }}</span>
                                </div>
                            </div>
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.fax_no') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_phone_fax">{{ $claim_case->opponent_address->phone_fax }}</span>
                                </div>
                            </div>
                            <div class="form-group" style="display: flex;">
                                <div class="control-label col-xs-4" style="padding-top: 13px;">{{ __('form1.email') }} </div>
                                <div class="col-xs-8 font-green-sharp" style="align-items: stretch;">
                                    <span id="view_opponent_email">{{ $claim_case->opponent_address->email }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
