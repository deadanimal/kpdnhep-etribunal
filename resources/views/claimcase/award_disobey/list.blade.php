    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                ...
                <span class="caption-subject bold uppercase">{{ __('new.list_award_disobey') }}</span>
            </div>
            <div class="tools"> </div>
        </div>
    ...
    var TableDatatablesButtons = function () {
        ...
        var oTable = table.DataTable({
            ...
            "columns": [
                ...
                { data: "method_id", name:"method.method_{{ App::getLocale() }}"},
            ...
            buttons: [
            {
                text:"<i class=\"fa fa-plus margin-right-5\"></i> {{ __('new.register_kpa') }}", className:"btn blue btn-outline", action:function()
                {
                    window.location.href = "{{ route('awarddisobey.find') }}"; 
                }
            },
            {
                    extend: 'print',
                    ...
                    title: function(){
                        return "<span style='font-size: 22px'><strong>e-Tribunal V2 | </strong>{{ __('new.list_award_disobey') }}</span>"; // #translate
                    },
                    ...
                    customize: function ( win ) {
                        ...
                        win.document.title = "List of Award Disobey";
