            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">{{ trans('new.list_stop_notice') }}</span>
                    </div>
                    <div class="tools"></div>
                </div>
                ...
                <div class="portlet-body">
                    <table id="stop_notice" class="table table-striped table-bordered table-hover table-responsive">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('new.process_date') }}</th>
                            <th>{{ trans('new.status') }}</th>
                            <th>{{ trans('new.method') }}</th>
        ...
        @section('after_scripts')
            ...
            <script type="text/javascript">
                ...
                var initTable1 = function () {
                  ...
                  var oTable = table.DataTable({
                    ...
                    'columns': [
                      ...
                      {
                        data: 'case_no', name: 'case.case_no', 'render': function (data, type, full) {
                          return $('<div/>').html(data).text()
                        }
                      },
                      { data: 'filing_date', name: 'case.form1.filing_date' },
                      { data: 'processed_at', name: 'processed_at' },
                      { data: 'form_status_id', name: "status.form_status_desc_{{ App::getLocale() }}" },
                      { data: 'stop_notice_method_id', name: "method.stop_method_{{ App::getLocale() }}" },
                    ...
                    buttons: [
                      {
                        text: "<i class=\"fa fa-plus margin-right-5\"></i> {{ trans('new.register_stop_notice')}} ",
              ...
              function processStopNotice(id) {
                $('#modalDiv').load("{{ url('/') }}/stop_notice/" + id + '/process')
              }
