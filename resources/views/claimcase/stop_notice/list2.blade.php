              ...
              var TableDatatablesButtons = function () {
                ...
                var initTable1 = function () {
                  ...
                  var oTable = table.DataTable({
                    'processing': true,
                    'serverSide': true,
                    'ajax': "{{ route('stopnotice-find') }}",
                    'deferRender': true,
                    'pagingType': 'bootstrap_full_number',
                    'columns': [
                      { data: null, 'orderable': false, 'searchable': false },
                      { data: 'case_no', name: 'claimCase.case_no' },
                      { data: 'filing_date', name: 'claimCase.form1.filing_date' },
                      { data: 'opponent_name', name: 'opponent_address.name' },
