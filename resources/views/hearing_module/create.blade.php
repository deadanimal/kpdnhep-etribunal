...
<div class="portlet-body">
    <form action="{{ route('hearing.storehearing') }}" class="form-horizontal" method="post" role="form"
          id="submitschedule">
        {{csrf_field()}}
        <table class="table table-striped table-bordered table-advance table-hover">
            ...
            <tr>
                ...
                <td><input class="form-control" name="hearing_date" id="hearing_date" type="text"
                           value="{{ date('d/m/Y', strtotime(strtr($date, '-', '/'))) }}"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width:25%"><b> {{ trans('hearing.state') }} <span style="color: red;">*</span></b></td>
                <td>
            ...
            <tr>
                <td style="width:25%"><b> {{ trans('hearing.ttpm_branch') }} <span style="color: red;">*</span></b></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <select required class="form-control" id="hearing_venue_id" name="venue_id" data-placeholder="---">
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select required class="form-control" id="hearing_room_id" name="hearing_room_id"
                            data-placeholder="---">
                    </select>
                </td>
            </tr>
...
<script type="text/javascript">
  ...
  $('#storepresidentschedule').on('click', function (e) {
    e.preventDefault()
    var url = "{{route('hearing.storehearing')}}"
    swal({
