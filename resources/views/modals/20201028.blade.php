    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body"
                        ...
                        <td>
                            @if(Lang::getLocale() == 'my')
                                <b>Arahan ini hanya terpakai untuk urusan di Pejabat Tribunal Tuntutan Pengguna (TTPM)
                                    ...
                                    Putrajaya sahaja.</b>
                                <br><br>
                                Sila ambil perhatian, susulan daripada pelanjutan Perintah Kawalan Pergerakan Bersyarat 
				(PKPB) di Negeri Sabah, Selangor, Wilayah Persekutuan Kuala Lumpur dan Putrajaya daripada 
				28 Oktober sehingga 9 November 2020, semua tuntutan boleh difailkan secara online di Sistem 
				e-Tribunal manakala bagi pemfailan tuntutan secara manual di kaunter TTPM hendaklah dibuat 
				secara temujanji sahaja. Bagi tujuan ini sila hubungi:-                                
				<br><br>
                                ...
                                Sila ambil maklum bahawa semua kes yang telah ditetapkan untuk pendengaran pada tempoh ini ditangguhkan 
				ke tarikh pendengaran baharu. Kesemua pihak yang terlibat akan dimaklumkan tarikh pendengaran baharu.
                                <br><br>
				...
				in State of Sabah, Selangor, Wilayah Persekutuan Kuala Lumpur and Putrajaya from 28<sup>th</sup> October 
				to 9<sup>th</sup> November 2020, all claims can be filed online at e-Tribunal System while filling claims 
				at TCCM counter shall only be made by way of appointment. For this purpose, please contact:
                                <br><br>
                                <table class="table table-condensed table-bordered">
                                    <tr>
                                        <td>(i)</td>
                                ...
                                Kindly be informed that all scheduled hearings during this 
				period have been postponed to a new hearing date. All parties 
				concerned will be notified of the new hearing date.                                <br><br>
