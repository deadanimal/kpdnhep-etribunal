                    ...
                    <tr>
                        <td>
                            @if(Lang::getLocale() == 'my')
                                ...
                                <br><br>
                                Sila ambil perhatian, susulan daripada pelanjutan Perintah Kawalan Pergerakan Bersyarat (PKPB) di seluruh 
								Negara kecuali Negeri Pahang, Kelantan dan Perlis daripada 9 November sehingga 6 Disember 2020, 
								semua tuntutan boleh difailkan secara online di Sistem e-Tribunal manakala bagi pemfailan tuntutan 
								secara manual di kaunter TTPM hendaklah dibuat secara temujanji sahaja. Bagi tujuan ini sila merujuk 
								kepada direktori pejabat TTPM melalui pautan ttpm.kpdnhep.gov.my.                                
								<br><br>
                            ...
                            @else
								...
								all State except Pahang, Kelantan and Perlis effective from 9<sup>th</sup> November to 6<sup>th</sup> December, 
								all claims can be filed online at e-Tribunal System while filling claims at TCCM counter shall 
								only be made by way of appointment. For this purpose, please refer to our website 
								at ttpm.kpdnhep.gov.my for contact details.
                                <br><br>
