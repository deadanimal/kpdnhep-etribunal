...
<div class='row' style="background-color: #f8f8f8;">
	<div class='col-md-3' style='padding: 30px;'>
		<h4 style="margin-bottom: 15px">Pengumuman</h4>
			...
			<div class="carousel-inner">
				...
				<div class="item {{ $index == 0 ? 'active' : '' }}">
					<div class="panel panel-success" @if($index > 0) class="hidden" @endif>
						<div class="panel-heading bold">{{ $announcement->title_my }}</div>
						<div class="panel-body" style="background-color: white;">{!! strlen($announcement->description_my) > 100 ? substr($announcement->description_my, 0, 100).'... <a href="javascript:;" onclick="openAnnouncement('.$announcement->portal_announcement_id.')" style="font-style: italic; font-weight: bold">Baca Lanjut</a>' : $announcement->description_my !!}</div>
					</div>
				</div>
				@endforeach
			</div>
