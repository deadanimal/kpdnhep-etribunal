					...
					<div class="carousel-inner">
						...
						<div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
							<div @if($index > 0) class="hidden" @endif>
								...
								<p>{!! strlen($announcement->description_en) > 100 ? substr($announcement->description_en, 0, 100).'...' : $announcement->description_en !!}</p>
								@if(strlen($announcement->description_en) > 100)
								<a href="javascript:;" onclick="openAnnouncement('{{ $announcement->portal_announcement_id }}')">Read more..</a>
								@endif
							</div>
						</div>
						@endforeach
