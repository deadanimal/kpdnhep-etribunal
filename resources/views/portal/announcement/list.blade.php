                    ...
                    <div id="search-form" class="form-inline">
                        ...
                        <div class="form-group mb10">
                            ...
                            <select id="month" class="form-control" name="month" style="margin-right: 10px;">
                                ...
                                <option @if(Request::get('month') == $i) selected @endif value="{{ $i }}">{{ $month }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb10">
            ...
            buttons: [
                {
                    text:"<i class=\"fa fa-plus margin-right-5\"></i> {{ trans('others.add_announcement')}}", className:"btn blue btn-outline", action:function()
                        {
                            window.location.href = "{{route('cms.announcement.create')}}";
                        }
                },
                {
                    extend: 'print',
...
function deleteAnnouncement(id) {
    ...
    function(){
        ...
        $.ajax({
            url: "{{ route('cms.announcement') }}/"+id+"/delete",
            type: "DELETE",
            data : {
                _token:_token,
                id:id
