        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">{{ trans('portal.page_list') }} </span>
                </div>
                <div class="tools"> </div>
            </div>
                ...
                <table id="menu" class="table table-striped table-bordered table-hover table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('portal.title') }}</th>
                            <th>{{ trans('portal.subtitle') }}</th>
                            <th>URL</th>
                            <th>{{ trans('portal.created_by') }} </th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ trans('portal.page_info')}}</h4>
            </div>
    ...
    var initTable1 = function () {
        ...
        var oTable = table.DataTable({
            ...
            "columns": [
                ...
                { data: "subtitle", name:"subtitlee_{{ App::getLocale() }}"},
                { data: "url", name:"url"},
            ...
            buttons: [
                {
                    text:"<i class=\"fa fa-plus margin-right-5\"></i> {{ trans('portal.add_page')}}", className:"btn blue btn-outline", action:function()
                        {
                            window.location.href = "{{route('cms.page.create')}}";
                        }
                },
                {
                    extend: 'print',
                    ...
                    title: function(){
                        return "<span style='font-size: 22px'><strong>e-Tribunal V2 | </strong>{{ trans('portal.page_list') }}</span>"; // #translate
                    },
                    ...
                    customize: function ( win ) {
                        ...
                        win.document.title = "{{ trans('portal.page_list') }}";
