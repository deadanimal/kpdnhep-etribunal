...
<input class="form-control hidden" name='fpx_id' value='{{ $fpx->payment_fpx_id }}'>
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-body">
                            <div class="form-group">
                                <label for="receipt_no" class="control-label col-md-5"> {{ __('new.receipt_no')}}  :
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-6">
                                    <input class="form-control" name='receipt_no' value='{{ $fpx->payment->receipt_no }}'>                                   
                                </div>
                            </div>
                        </div>
                    </form>
