    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ __('new.report18')}}</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 form">
                        <form id="submitForm" action="{{ url('') }}/report/report18/view" method="GET"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label for="category" class="control-label col-md-4">{{ trans('new.category')}} :
                                        <span> &nbsp;&nbsp; </span>
                                    </label>
                                    <div class="col-md-5">
                                        <select required onchange="loadClassification()" id="category"
                                                class="form-control select2 bs-select" name="category"
                                ...
                                <div class="form-group form-md-line-input">
                                    <label for="classification"
                                           class="control-label col-md-4">{{ trans('new.classification')}} :
                                        <span> &nbsp;&nbsp; </span>
                                    </label>
                                    <div class="col-md-5">
                                        <select id="classification" class="form-control select2 bs-select"
                                                name="classification" style="margin-right: 10px;">
                                            <option value="0" selected>-- {{ __('new.all') }} --</option>
                                ...
                                <div class="form-group form-md-line-input">
                                    <label for="state_id" class="control-label col-md-4">{{ trans('new.state')}} :
                                        <span> &nbsp;&nbsp; </span>
                                    </label>
                                    <div class="col-md-5">
