  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('new.list_cases') }}</h4>
        </div>
...
var TableDatatablesButtons = function () {
        ...
        var oTable = table.DataTable({
            "processing": true,
            "serverSide": true,
            // "ajax": "{!! route('report2-data-solution', ['state_id' => $state_id, 'solution' => $solution ,'year' => $year, 'month' => $month]) !!}",
            "ajax": "{!! route('report2-data-solution', ['state_id' => $state_id, 'solution' => $solution ,'year' => $year, 'month' => $month, 'date_start' => $date_start, 'date_end' => $date_end]) !!}",
            "deferRender": true,
