  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('new.report14')}}</h4>
        </div>
        <div class="modal-body"> 
            <div class="row">
                <div class="col-md-12 form">
                    <form id="submitForm" action="{{ url('') }}/report/report14/view" method="GET" class="form-horizontal" role="form">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-4"> {{ __('new.opponent_type')}}  :
                                    <span> &nbsp;&nbsp; </span>
                                </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"> {{ __('new.category')}}  :
                                    <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5" style="margin-top: 7px;">
                                    <select required onchange="loadClassification()" class="form-control select2 bs-select" id="claim_category" name="claim_category"  data-placeholder="---">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"> {{ __('new.classification')}}  :
                                    <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5" style="margin-top: 7px;">
                                    <select required class="form-control select2 bs-select" id="claim_classification" name="claim_classification"  data-placeholder="---">
