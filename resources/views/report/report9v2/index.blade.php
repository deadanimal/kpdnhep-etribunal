                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group input-medium date date-picker"
                                            ...
                                            <input class="form-control datepicker"
                                                   ...
                                                   data-date-format="dd/mm/yyyy"
                                                   type="text"
                                                   value="{{ \Carbon\Carbon::parse($input['date_start'])->format('d/m/Y') }}"/>
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group input-medium date date-picker"
                                            ...
                                            <input class="form-control datepicker"
                                                   ...
                                                   data-date-format="dd/mm/yyyy"
                                                   type="text"
                                                   value="{{ \Carbon\Carbon::parse($input['date_end'])->format('d/m/Y') }}"/>
                                            <span class="input-group-btn">
                                                <button class="btn default" type="button">
                                                    <i class="fa fa-calendar"></i>
                                                </button>
                                    ...
                                    <div class="col-md-5">
                                        <select id="state_id" class="form-control select2 bs-select" name="state_id"
                                            ...
                                            @foreach($state_list as $id => $state)
                                                <option @if($input['state_id'] == $id ) selected
                ...
                <div class="portlet-body">
                    ...
                    @if(!!$is_search)
                        <div class="table-scrollable">
                            @include('report.report9v2.table')
                        </div>
                    @endif
                </div>
            </div>
