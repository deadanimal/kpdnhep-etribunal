    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">{{ __('new.total_case_completed')}}</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 form">
                        <form id="submitForm" action="{{ url('') }}/report/report5/view" method="GET"
                              class="form-horizontal" role="form">
                            <div class="form-body">
                                <div class="form-group form-md-line-input">
                                    <label for="day" class="control-label col-md-4"> {{ __('new.day')}} :
                                        <span> &nbsp;&nbsp; </span>
                                    </label>
                                    <div class="col-md-5">
                                        <input id="day" name="day" class="form-control numeric" type="text" value="60">
                                    </div>
                                </div>
                                <div class="form-body">
                                    <div class="form-group form-md-line-input">
