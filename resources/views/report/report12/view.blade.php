...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            <span id='title' class="caption-subject uppercase bold">{{ __('new.record_brochure')}} {{ __('new.year') .' '.$year }}</span>     
        </div>
        <div class="tools"> 
    ...
    {{ Form::open(['route' => 'report12-update', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'submitForm']) }}
    
    <input type='hidden' name='year' value='{{ Request::has('year') ? Request::get('year') : date('Y') }}' />

    <div class="portlet-body">
        <div class="table-scrollable">
            <table id="report12" class="table table-striped table-bordered table-hover table-responsive">
                <thead align="center">
                ...
                <tbody align="center">
                    ...
                    ?>
                     <tr align="center">
                        ...
                        <?php
                            $val_state = (clone $recordbrochures)->where('state_id', $state->state_id); 
                        ?>
...
function exportPDF() {
        location.href = "{{ url('') }}/report/report12/export/pdf?{!! http_build_query(request()->input()) !!}";
    }
