  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('new.report27')}}</h4>
        </div>
        <div class="modal-body"> 
            <div class="row">
                <div class="col-md-12 form">
                    <form id="submitForm" action="{{ url('') }}/report/report27/view" method="GET" class="form-horizontal" role="form">
                        <div class="form-body">
                            ...
                            {{-- <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-5">
                                    <select id="month" class="form-control select2 bs-select" name="month" style="margin-right: 10px;">
                                        <option value="0" >-- {{ __('form1.all_month') }} --</option>
                            ...
                            <div class="form-group form-md-line-input">
                                <label for="date_start" class="control-label col-md-4">
                                    {{ __('new.date_start')}} : <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5">
                            ...
                            <div class="form-group form-md-line-input">
                                <label for="date_end" class="control-label col-md-4">
                                    {{ __('new.date_end')}} : <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5">
                                    <div class="input-group input-medium date date-picker"
                                        style="margin-right: 10px;" data-date-format="dd/mm/yyyy"
                            ...
                            <div class="form-group form-md-line-input">
                                <label for="state_id" class="control-label col-md-4">
                                    {{ trans('new.state')}} : <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5">
