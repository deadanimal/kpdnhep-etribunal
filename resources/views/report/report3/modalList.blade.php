  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('form1.form1_list') }}</h4>
        </div>
...
var TableDatatablesButtons = function () {
        ...
        var oTable = table.DataTable({
            ...
            "ajax": "{!! route('report3-data-form1', ['state_id' => $state_id, 'year' => $year, 'month' => $month, 'date_start' => $date_start, 'date_end' => $date_end]) !!}",
            "deferRender": true,
