  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('new.report23')}}</h4>
        </div>
        <div class="modal-body"> 
            <div class="row">
                <div class="col-md-12 form">
                    <form id="submitForm" action="{{ url('') }}/report/report23/view" method="GET" class="form-horizontal" role="form">
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                <label for="date" class="control-label col-md-4"> {{ __('new.year')}}:
                                    <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5">
                            ...
                            <div class="form-group form-md-line-input">
                                <label for="date" class="control-label col-md-4"> {{ __('new.month')}} :
                                    <span> &nbsp;&nbsp; </span>
                                </label>
                                <div class="col-md-5">
                                    <select id="month" class="form-control select2 bs-select" name="month" style="margin-right: 10px;">
                                        <option value=" " selected >--{{ __('form1.all_month') }}--</option>
