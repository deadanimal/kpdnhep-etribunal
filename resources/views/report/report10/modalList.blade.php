  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">{{ __('inquiry.inquiry_list') }}</h4>
        </div>
                ...
                <table id="stop_notice" class="table table-striped table-bordered table-hover table-responsive list-modal">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('inquiry.inquiry_no') }}</th>
                        </tr>
                    </thead> 
                </table>
            </div>
...
var TableDatatablesButtons = function () {
        ...
        var oTable = table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{!! route('report10-data', ['state_id' => $state_id, 'year' => $year, 'month_id' => $month_id]) !!}",
            "deferRender": true,
            "pagingType": "bootstrap_full_number",
            "columns": [
                // {data: 'rownum'},
                { data: 'id', defaultContent: '', 'orderable' : false, 'searchable' : false},
                { data: "inquiry_no", name:"inquiry.inquiry_no", 'orderable' : false, 'render': function ( data, type, full ){
