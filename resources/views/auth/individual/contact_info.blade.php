...
{{ textInputNumeric($errors, 'text', NULL, 'phone_home', trans('new.phone_home')) }}

{{ textInputNumeric($errors, 'text', NULL, 'phone_mobile', trans('new.phone_mobile'), true) }}
...
@if(Route::current()->getName() == 'citizen')
    {{ textInput($errors, 'alternative_email', NULL, 'alternative_email', trans('new.alternative_email')) }}
@endif
